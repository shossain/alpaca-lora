...
if __name__ == "__main__":
    ...
    parser.add_argument("--do_loss_weight_averaging", default=False, action="store_true")
    parser.add_argument("--loss_type", type=str, default='cross_entropy') # cross_entropy, focal, generalized_dice, soft_dice TODO: enum
    parser.add_argument("--label_smoothing_factor", type=str, default=0.)
